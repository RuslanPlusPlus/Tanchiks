...
str_game_tip db "Metal is unbreakable, but you can break walls and even ride on trees$"
...
p_lives_default dw 3				;start value of p_lives
...
controls_instructions: 						;outputs game controls and instructions
	...
	out_str str_bonus_instruction1, 2, 4, c_cyan
	out_str str_bonus_instruction2, 2, 5, c_cyan
	out_str str_game_tip, 2, 7, c_red
...
game_menu:									;main game menu
	...
	;1. Start game
	out_str str_controls, 2, 2, c_cyan
	;2. Controls
	out_str str_exit, 2, 5, c_green
	;3. Exit
